...
## Extract 6 key featuers and put them in the new data frame
...
The adjusted for R squared is 0.63  ($R^{2}$= 0.63), which indicates the regression equation is SOMEWHAT useful for making predictions.
```{r, echo=FALSE}
...
## Model Intepretation:
Our best estimate for the common standard deviation of all life ladder (happiness index) for all countries at any particlar GDP, Social Support, Healthy Life Expectancy, Freedom, Generosity, and corruption is 0.6813. 
...
By looking at the p value for the f test, p value = 2.2e-16 (p < 0.05), we reject the null hypothesis. At the 5% significance level, the data provides sufficient edvidence to reject the null ${beta_1 = beta_2 = beta_5 = 0}$ . Hence, in conjunction with other variables, GDP, Social Support, and Generosity are useful predictors of the happiness. 
```{r, include= TRUE}
